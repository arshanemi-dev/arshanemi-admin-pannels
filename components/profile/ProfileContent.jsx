...
// Shared profile experience — rendered at both /settings/profile (staff, inside
// the admin shell) and /profile (plain 'user' role, inside the normal public
// site layout). Fully self-contained: fetches its own data via /api/auth/me
// (cookie or Bearer auth), so it doesn't care which shell it's mounted in —
// only needs a ToastProvider ancestor for the save/update toasts.
