export const caseStudyTestimonials = [
  {
    quote: 'Great service great communication one of the best companies for SEO.',
    name: 'Salem Basheer Muhammad',
    role: 'CEO, AEDBS',
    result: '300K+ Impressions',
  },
  {
    quote: 'Exceptional work! Delivered beyond expectations in record time.',
    name: 'Marie Wilson',
    role: 'Business Owner',
    result: 'Top 3 Rankings',
  },
  {
    quote: 'Super excited — my website received Google AdSense approval after their SEO work.',
    name: 'Walter O\'Neill',
    role: 'Founder, Antiques Arena',
    result: 'AdSense Approved',
  },
];
