...
// components/layout/Footer.jsx's dynamic LucideIcons[icon] lookup, which
// silently renders blank for the same reason). Small inline SVGs instead of
// leaving three of four badges empty.
  ...
  return (
    <div className="rounded-2xl bg-gradient-to-r from-[#4a5fd9] to-[#f0763f] px-6 py-5 flex flex-wrap items-center justify-between gap-6">
      ...
      <div className="flex flex-col items-start sm:items-end gap-2">
        <p className="text-sm font-bold text-white">Training link</p>
