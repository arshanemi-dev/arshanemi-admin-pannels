...
export default function EditServicePage() {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-3xl mx-auto pb-24 flex flex-col gap-5">
      <PageHeader title="Edit Service" backHref="/admin/services" />
      ...
      <SectionCard title="Stats Strip">
        <p className="text-xs text-gray-500 -mt-1">Shown as a 4-column metrics strip below the hero. Add up to 8 stats; remove any you don't need.</p>
        <ArraySection
          title="Stat Items"
          items={stats}
