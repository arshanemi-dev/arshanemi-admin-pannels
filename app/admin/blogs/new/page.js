...
export default function NewBlogPage() {
  ...
  return (
    <div className="pb-20">
      <PageHeader title="New Blog Post" backHref="/admin/blogs" />
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-8 flex flex-col gap-5">
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-sm font-medium text-gray-700">
                Excerpt <span className="text-gray-400 font-normal">({charCount}/160)</span>
              </label>
              <textarea
                value={form.excerpt}
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
            <h3 className="text-sm font-semibold text-gray-700 mb-4">Content Blocks</h3>
        ...
        <div className="col-span-4 flex flex-col gap-5">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 flex flex-col gap-4">
            ...
            <div className="flex gap-2">
              <button type="button" onClick={() => save('draft')} disabled={loading}
                className="flex-1 py-2 rounded-xl border border-gray-300 text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-60 transition-colors">
                Save Draft
              </button>
              <button type="button" onClick={() => save('published')} disabled={loading}
                className="flex-1 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold disabled:opacity-60 transition-colors">
          ...
          {(form.title || form.excerpt) && (
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-5">
              ...
              <div className="text-xs text-gray-400 mb-1">santhyainfotech.com › blog</div>
