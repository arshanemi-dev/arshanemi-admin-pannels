...
export const NAV_CONFIG = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'customer-dashboard', label: 'Customer Dashboard', href: '/settings/customer-dashboard', icon: 'BarChart2', roles: ['master_admin', 'admin'] },
    ],
  },
  {
    label: 'BILLING & WALLET',
    items: [
      { key: 'wallet', label: 'Wallet', href: '/settings/wallet', icon: 'Wallet', roles: ['master_admin', 'admin'] },
      { key: 'promo-offers', label: 'Promo Offers', href: '/settings/promo-offers', icon: 'BadgePercent', roles: ['master_admin', 'admin'] },
    ],
  },
  {
    label: 'LEADS & HR',
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'plan', label: 'Plan', href: '/settings/plan', icon: 'CreditCard', roles: ['master_admin', 'admin', 'user'] },
    ],
  },
]
