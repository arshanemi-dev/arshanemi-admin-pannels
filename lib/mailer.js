              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                  <td style="padding-top:12px;">
                    <p style="margin:0;color:#4b5563;font-size:11px;">This email was generated automatically by the Santhya Infotech website. Please do not reply directly to this address.</p>
                  </td>
                </tr>
              </table>
            </td>
...
export function buildContactEmail({ name, email, phone, budget, service, message }) {
  ...
  const bodyContent = `
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:28px;">
      <tr>
        <td align="center">
          <a href="mailto:${email}?subject=Re: Your Enquiry — Santhya Infotech"
  ...
  return {
    subject: `📩 New Enquiry from ${name} — Santhya Infotech`,
    html: emailShell({
...
export function buildLeadEmail({ name, email, phone, interest }) {
  ...
  const bodyContent = `
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:28px;">
      <tr>
        <td align="center">
          <a href="mailto:${email}?subject=Your Free SEO Audit — Santhya Infotech"
             style="display:inline-block;background:linear-gradient(135deg,#4f46e5,#06b6d4);color:#ffffff;font-size:14px;font-weight:700;padding:12px 32px;border-radius:8px;text-decoration:none;letter-spacing:0.3px;">
            Contact ${name} Now
          </a>
        </td>
...
export function buildApplicationEmail({ applicantName, applicantEmail, applicantPhone, jobTitle, coverLetter, resumeUrl, resumeFileName }) {
  ...
  const bodyContent = `
    ...
    <p style="margin:0 0 28px;color:#a3a3a3;font-size:13px;">A candidate applied via the Santhya Infotech careers page. Details below:</p>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:28px;">
      <tr>
        <td align="center">
          <a href="mailto:${applicantEmail}?subject=Re: Your Application for ${encodeURIComponent(jobTitle)} — Santhya Infotech"
             style="display:inline-block;background:linear-gradient(135deg,#4f46e5,#06b6d4);color:#ffffff;font-size:14px;font-weight:700;padding:12px 32px;border-radius:8px;text-decoration:none;letter-spacing:0.3px;">
